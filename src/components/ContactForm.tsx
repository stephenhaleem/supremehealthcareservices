...
const ContactForm = () => {
  ...
  return (
    <section className="animate-section theme-wash py-20" id="contact-form">
      <div className="container max-w-4xl">
        <div className="text-center max-w-2xl mx-auto mb-14">
          <p className="section-label">Get started</p>
          <h2 className="section-title mt-5">Request a Free Care Assessment</h2>
          <p className="mt-4 text-sm text-muted-foreground">Fill out the form below and a care coordinator will contact you within 24 hours.</p>
        </div>
        <form onSubmit={handleSubmit} className="reveal-card grid sm:grid-cols-2 gap-4">
