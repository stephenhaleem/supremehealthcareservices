      ...
      <div className="grid gap-12 border-b border-background/15 pb-20 sm:grid-cols-2 lg:grid-cols-[1.3fr_.8fr_.8fr_1fr]">
        <div>
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-bold uppercase">Rooted With You</span>
          </div>
          <p className="mt-6 max-w-xs text-sm leading-6 text-background/55">
            Licensed healthcare aides delivering dependable, compassionate home
            care throughout Alberta.
          </p>
        </div>
        <div>
          <p className="footer-label">Explore</p>
          <div className="mt-5 grid gap-3 text-xs text-background/60">
            <Link to="/">Home</Link>
        ...
        <div>
          ...
          <div className="mt-5 grid gap-3 text-xs text-background/60">
            ...
            <Link to="/services">Dementia care</Link>
            <Link to="/services">Respite care</Link>
        ...
        <div>
          ...
          <div className="mt-5 grid gap-3 text-xs text-background/60">
            <a href="tel:18005550273">1-800-555-CARE</a>
            <a href="mailto:info@comfortcare.ca">info@comfortcare.ca</a>
            <span>Serving all Alberta</span>
